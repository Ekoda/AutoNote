...
def withContext(transcribed_text):
    CONTEXT = "You are a masterful note-taker, a clear and concise communicator, able to make sense of any material given. You are tasked with summarizing the key points of what happend during a meeting. You are given the following transcript of the meeting: "
